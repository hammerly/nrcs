...
pi <- parseWebReport("https://nasis.sc.egov.usda.gov/NasisReportsWebSite/limsreport.aspx?report_name=get_project_from_LIMS", args = list(p_mlrassoarea = params$mlrassoarea, p_fy = params$fiscalyear))
...
ssmu <- read_sf(dsn = paste0("E:/geodata/project_data/11", str_sub(params$mlrassoarea, -3, -1), "/RTSD_MLRA_11-", str_sub(params$mlrassoarea, -3, -1), "_FY18.gdb"), layer = "MUPOLYGON")
